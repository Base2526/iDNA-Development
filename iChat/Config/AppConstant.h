...
#define RELOAD_DATA_MY_APPLICATIONS  @"reload_data_my_applications" // MyApplications
#define RELOAD_DATA_FOLLOWING      @"reload_data_following"         // Following
#define RELOAD_DATA_SLIDE_SHOW     @"reload_data_slide_show"        // Slide show
#define RELOAD_DATA_CENTER         @"reload_data_center"
